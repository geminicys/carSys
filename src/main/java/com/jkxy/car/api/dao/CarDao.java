...
public interface CarDao {
    ...
    List<Car> wildcardFindByCarName(String carName, int offset, int rows);

    @Update("update carMessage set inventory=inventory-#{count} where id = #{id}")
    void updateInventoryById(int count, int id);
}
